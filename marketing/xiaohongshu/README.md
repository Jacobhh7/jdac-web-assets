...
| 順序 | 檔案 | 任務 |
| --- | --- | --- |
| 1 | `out/1-cover-sc.png` | 封面。上照片下黑底大字報，只講一句痛點，3 秒內要被看懂 |
...
- 封面走「痛點＋結果」公式，視覺衝擊優先於資訊量；真實照片比精修圖有效
...
| 檔案 | 來源 |
| --- | --- |
| `p1-class.jpg` | 工作坊現場（封面上半） |
| `p2-band.jpg` | 同場景，第 2 張的橫幅 |
| `p3-portrait.jpg` | 人像（第 3 張自介） |
